...
contract FundMeTest is Test {
    ...
    modifier funded() {
        // This modifier is used to set up a test scenario where the FundMe contract has already been funded by the USER address. It allows you to reuse this setup in multiple test functions without duplicating code.
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
        _;
    }
    ...
    function testWithDrawFromMultipleFunders() public funded {
        ...
        for (
            uint160 i = startingFunderIndex; // This line starts a for loop that iterates from startingFunderIndex (1) to numberOfFunders (10). It creates multiple funder addresses and simulates funding the FundMe contract from each of them.
            i < numberOfFunders;
            i++
        ) {
